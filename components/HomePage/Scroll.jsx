...
import ball from "@/assets/images/HomePage/second.jpg";
import leaf from "@/assets/images/HomePage/sixth.jpg";
import biscuit from "@/assets/images/HomePage/first.jpg";
import potLeaf from "@/assets/images/HomePage/seventh.jpg";
import boxBiscuit from "@/assets/images/HomePage/nine.jpg";
import leafMirror from "@/assets/images/HomePage/eighth.jpg";
import masale from "@/assets/images/HomePage/fourth.jpg";
      ...
      <section ref={container} className="hidden md:block">
        ...
        <div className="grid grid-cols-3 bg-white h-[100vh]">
          ...
          <div className="flex items-center bg-white biscuit">
            <Image
              src={biscuit}
              className="object-cover h-full image2"
              alt="biscuit"
            />
          </div>
          <div></div>
        ...
        <div className="grid grid-cols-3 bg-white h-[100vh]">
          ...
          <div className="mx-auto my-auto ">
            <Image
              src={boxBiscuit}
              className="object-cover h-screen image3"
              alt="biscuit"
            />
          </div>
